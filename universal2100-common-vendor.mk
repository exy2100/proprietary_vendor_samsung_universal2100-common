...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/universal2100-common/proprietary/vendor/etc/mtu-conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mtu-conf.xml \
    ...
    vendor/samsung/universal2100-common/proprietary/vendor/etc/plmn_delta_hktw.bin:$(TARGET_COPY_OUT_VENDOR)/etc/plmn_delta_hktw.bin \
    vendor/samsung/universal2100-common/proprietary/vendor/etc/plmn_delta_ltn.bin:$(TARGET_COPY_OUT_VENDOR)/etc/plmn_delta_ltn.bin \
    ...
    vendor/samsung/universal2100-common/proprietary/vendor/etc/plmn_se13_prebuilt.bin:$(TARGET_COPY_OUT_VENDOR)/etc/plmn_se13_prebuilt.bin \
    vendor/samsung/universal2100-common/proprietary/vendor/etc/secnvm/k250a_00000304_c.img:$(TARGET_COPY_OUT_VENDOR)/etc/secnvm/k250a_00000304_c.img \
    ...
    vendor/samsung/universal2100-common/proprietary/vendor/firmware/APBiBF_AUDIO_SLSI.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/APBiBF_AUDIO_SLSI.bin \
